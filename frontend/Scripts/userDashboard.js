        ...
        <div class="cards" data-aos="zoom-out" data-set="${elem._id}">
            ...
            <div class="cards-2">
                <div class="cards-mid">
                    ...
                    <div>
                        <p>Experience</p>
                        <b>${elem.experience} yrs</b>
                    </div>
                </div>
                <div class="cards-bottom">
                    <h4><img src="./images/workingProfessionals/email.png" alt="email"> ${elem.email}</h4>
                    <h4><img src="./images/workingProfessionals/call.png" alt="call"> ${elem.phone}</h4>
                </div>
            </div>
